        ...
        switch (main_api) {
            ...
            case 'openai':
                if (((secret_state[SECRET_KEYS.OPENAI] || oai_settings.reverse_proxy) && oai_settings.chat_completion_source == chat_completion_sources.OPENAI)
                    ...
                    || (secret_state[SECRET_KEYS.INFERSIA] && oai_settings.chat_completion_source == chat_completion_sources.INFERSIA)
                    ...
                    || (secret_state[SECRET_KEYS.OPENCODEGO] && oai_settings.chat_completion_source == chat_completion_sources.OPENCODEGO)
                    ...
                    || (secret_state[SECRET_KEYS.CONCENTRATE] && oai_settings.chat_completion_source == chat_completion_sources.CONCENTRATE)
