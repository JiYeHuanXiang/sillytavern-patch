...
import { deepMerge, humanizedDateTime, tryParse, MemoryLimitedMap, getConfigValue, mutateJsonString, clientRelativePath, getUniqueName, getArrayBufferSlice, sanitizeSafeCharacterReplacements, findPngFilesRecursiveAsync, invalidateDirListCache } from '../util.js';
...
router.post('/rename', validateAvatarUrlMiddleware, async function (request, response) {
    ...
    try {
        ...
        if (fs.existsSync(oldChatsPath) && !fs.existsSync(newChatsPath)) {
            ...
            await fsPromises.cp(oldChatsPath, newChatsPath, { recursive: true, filter: () => true });
